...
import { defaultPosts as staticPosts } from "../data/defaultPosts";
...
export default function PublicSite({ config, onBackToAdmin }: PublicSiteProps) {
  ...
  // Interactive repair diagnostic states
                  ...
                  {[
                    {
                      ...
                      title: "Agendamento",
                      badge: "WhatsApp",
                      desc: "Mande uma mensagem para agendar a entrega presencial ou acionamos o sistema Leva e Traz."
                    },
                    {
                      step: "02",
            ...
            <div className="md:col-span-4 space-y-3">
              ...
              <div className="flex items-start gap-2.5 text-neutral-400">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-neutral-500 text-[10px] italic">Tecnologia em mãos. Confiança em cada conserto.</p>
                </div>
              </div>
            </div>
